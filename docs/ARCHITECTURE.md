...
3. Target service processes request and returns standardized API response.
4. For orchestrated flows (orders), service-to-service calls and event publishing occur.
...
- Gateway-level auth enforcement strategy is **to be verified**
